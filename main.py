...
bot = telebot.TeleBot('6691638999:AAHHB9EBkN_Zkbz0gpsEICPZz7er-HAAWME')

def webAppKeyboard(): #создание клавиатуры с webapp кнопкой
   keyboard = types.ReplyKeyboardMarkup(row_width=1) #создаем клавиатуру
   webAppTest = types.WebAppInfo("https://kodeeodsdss.github.io/Kodeeodsdss/") #создаем webappinfo - формат хранения url
   webAppGame = types.WebAppInfo("https://kodeeodsdss.github.io/Kodeeodsdss/") #создаем webappinfo - формат хранения url
...
def webAppKeyboardInline(): #создание inline-клавиатуры с webapp кнопкой
   ...
   webApp = types.WebAppInfo("https://kodeeodsdss.github.io/Kodeeodsdss/") #создаем webappinfo - формат хранения url
